...
plt.savefig('mobility_death_by_cause_rich.pdf', transparent=True, bbox_inches='tight')
plt.show()
...
plt.xlabel('Percent change of people staying at home', fontsize=fontsize)
plt.tick_params(axis='both', labelsize=labelsize)
plt.savefig('mobility_death_by_cause_poor.pdf', transparent=True, bbox_inches='tight')
plt.show()
...
plt.ylabel(r'Deaths per $10^5$ people', fontsize=fontsize)
plt.tick_params(axis='both', labelsize=labelsize)
plt.savefig('mobility_combined_deaths.pdf', transparent=True, bbox_inches='tight')
plt.show()
